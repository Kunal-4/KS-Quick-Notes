...
// Function to show elsments from localStorage in the form of card in html page
function showNotes() {
    let notes = localStorage.getItem("notes");
    if (notes == null) {
        notesObj = [];
    ...
    if (notesObj.length != 0) {
        ...
        notesElm.innerHTML = 'Nothing to show! Use "Add a Note" seciton sbove to add notes.';
    }
}
